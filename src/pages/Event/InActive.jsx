...
function InActive({role, click, inActiveData}) {
    ...
    <div>
      ...
      <div className='py-6 border-1 border-gray-100'>
        ...
        {inActiveData?.map((item,index)=>
            <div className='bg-white rounded-xl p-5 relative mb-3' key={item._id}>
                <div className='flex justify-between'>
                    ...
                    {role==="admin"? <button className='cursor-pointer h-[24px]' onClick={(e)=>showEditBox(item._id,e)}> <img src='/Images/edit.svg' alt='edit' />
                    </button>:""}
                </div>
